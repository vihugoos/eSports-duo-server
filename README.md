...
The eSports Duo Server API to access all platform features, such as listing all games, creating a new ad, returning all ads by game and the discord of a specific ad. 
